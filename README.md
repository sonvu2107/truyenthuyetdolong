...
Phiên bản `20260711questvi1` giữ nền login, chế độ phóng to gameplay, 733 chuỗi kỹ năng, 5.285 chuỗi vật phẩm, 219 chuỗi nhiệm vụ và bản vá chống tự chạy nhầm cổng cấp 25. Bản này đối chiếu đủ 3.069 mục trong `ClientLang.txt`, biên dịch 5.921 phép gán của lớp `lang.ZH_CN` và vá 1.029 vị trí chuỗi hard-code trong 268 lớp giao diện/gameplay. Gói kỹ năng, vật phẩm và nhiệm vụ được biên dịch lại từ CBP sạch, giữ nguyên 18.239 node kỹ năng, 380.242 node vật phẩm và 24.977 node nhiệm vụ; 575 mục vật phẩm cùng các nhiệm vụ chưa có cặp dữ liệu an toàn được giữ nguyên tiếng Trung để tránh hiện sai thông tin. Sau khi nhập, toàn bộ 2.937 lớp ActionScript được xuất ngược để kiểm tra: không có lớp lỗi decompile, không còn Hán tự hiển thị ngoài danh sách kỹ thuật và điều kiện cùng map của `LocalPlayer` vẫn còn nguyên.
