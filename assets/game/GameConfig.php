...
$gameName = GAMENAME;
$key='differofzjcqha';
$flash_vars="srvaddr=".$_srvAddr."&srvport=".$_srvPort."&srvid=".$_srvId."&spid=".$SPID."&ressite=".$_resSite."&rankurl=".$_rankServer."&payurl=".$_payUrl."&user=".$LoginUser."&spverify=".$LoginVerify."&gameName=".$gameName."&lang=".LANGUAGE."&repus=".$RepUS."&frameRate=48&cbppack=1&ver=20260711short2&nocache=1&homeURL=".HOMEURL."&forumURL=".BBSURL.'&client='.$_SESSION['client'].'&clienURL='.CLIENT_DOWN_URL;
