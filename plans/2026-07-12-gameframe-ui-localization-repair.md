...
- Nguyên nhân đã truy được: entry `Item.txt:i2875` có một dấu `\` lẻ ở cuối `target` (source không có). Khi chèn vào chuỗi Lua, dấu này escape nháy đóng và làm vỡ cấu trúc bảng. Không phải do logic route/NPC thiếu điều kiện.
