...
param(
    ...
    [string]$ExpectedVersion = '20260714logicvi3'
)
...
try {
    ...
    Get-RemoteFile -Url ($RawBase.TrimEnd('/') + '/assets/manifest-logicserver-language-20260714-v3.json') -Destination $manifestPath
